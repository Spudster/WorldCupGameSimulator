...
public static partial class CommentaryPhrases
{
    ...
    private static readonly string[] YellowCards =
    {
        ...
        // ref reaching for the pocket
        "the referee's hand goes to his pocket — out comes yellow",
        "the official reaches into his breast pocket and produces the yellow",
        "up goes the referee's hand and out comes the card — yellow",
        "the referee dips into his pocket — a yellow card is shown",
        "a deliberate reach into the pocket and the yellow is held aloft",
        "the official barely pauses before going to his pocket for the yellow",
        "the referee's hand goes straight to his pocket — booked",
        // stern talking-to instead of a card
        "gets away with just a very stern word from the referee",
        "the referee wags his finger but does not reach for his pocket — a let-off",
        "spoken to firmly by the referee — fortunate not to see yellow",
        "given a lengthy dressing-down by the official — no card this time",
        "the referee points and lectures him — a booking seemed certain",
        "a long hard stare and a pointing finger — the card stays in the pocket",
        "the official pulls him aside for a quiet but firm word — no yellow",
        // player protesting innocence
        "shown yellow — and he protests his innocence furiously",
        "booked, though he can't believe it and spreads his arms wide",
        "carded and immediately throws his hands up in disbelief",
        "cautioned and walks away shaking his head in disagreement",
        "shown the yellow but is having none of it — gesturing to his arm",
        "into the book and he turns away muttering under his breath",
        "booked — he throws his arms wide and looks to the linesman for support",
        // team-mates surrounding the referee
        "the yellow is shown and team-mates rush in to argue the call",
        "half the side swarms around the referee to contest the booking",
        "players crowd the official but the yellow card has already been produced",
        "there are protests from all quarters but the referee stands firm with the yellow",
        // captain calming things down
        "the captain has to usher his own team-mates away before things escalate",
        "the skipper grabs a team-mate by the arm to stop further argument",
        "it takes the captain to drag the protesting players back as the yellow is shown",
        // additional straightforward entries
        "cautioned — and the referee will hear no further complaint",
        "shown yellow and immediately waved away by the official",
        "the yellow is out and there is no room for debate",
        "booked — the card is held aloft and the matter is settled",
        "into the referee's book for the challenge",
        "cautioned without ceremony — yellow",
        "the official makes no fuss, just books him",
        "shown a yellow card and pointed away",
        "picks up a booking he won't forget in a hurry",
        "earns a yellow card for his troubles",
        "the referee has no hesitation — yellow card shown",
        "cautioned and lucky it isn't worse",
        "a yellow card — he must now be very careful",
        "in the book and he knows he is walking a tightrope",
        "booked — one more and he'll be watching from the changing room",
    };
    ...
    private static readonly string[] StraightReds =
    {
        ...
        // ref dramatically reaching for red
        "the referee's hand bypasses the yellow entirely and goes straight for the red!",
        "no yellow, no warning — out comes the red card!",
        "the official's hand goes to his pocket and it is red — straight red!",
        "he reaches into his top pocket and produces the red — straight dismissal!",
        "the referee does not even contemplate yellow — it is red, and he's off!",
        // player protesting the straight red
        "shown the straight red and he is absolutely livid — he can\'t believe it!",
        "dismissed and immediately holds his arms out in total disbelief!",
        "a straight red — and he argues every step of the way to the tunnel!",
        "sent off and shaking his head as he makes the long walk to the dressing room!",
        "the red is shown and he protests furiously before team-mates usher him away!",
        "off he goes — but not without telling the referee exactly what he thinks!",
        // team-mates and captain
        "the red is shown and team-mates surge in from every direction to plead his case!",
        "there is uproar — half the side surrounding the referee after the straight red!",
        "the captain tries to calm his players but there is outrage at the straight red!",
        "the skipper grabs a shirt and tugs players away as the red card is raised!",
        "it takes the captain\'s intervention to prevent the situation worsening further!",
        // trudging off
        "he trudges to the tunnel, boots clipping the turf with every reluctant step!",
        "a slow, dejected walk to the dressing room — his World Cup afternoon is over!",
        "he cuts a lonely figure as he makes his way off the pitch!",
        "head bowed, he walks the long walk alone — a straight red, and he is gone!",
        "he peels away from the group and walks slowly towards the tunnel!",
        // team reorganising a man down
        "and now his side must reorganise with ten men for the rest of this match!",
        "the manager is already on his feet working out how to reshape a ten-man side!",
        "they will have to dig deep — down to ten men with plenty still to play!",
        "a man down, and the remaining ten must hold firm and work twice as hard!",
        "the shape will have to change — this side now play the rest with ten!",
        "ten men — the tactical reshuffle begins immediately on the touchline!",
        "they gather in a huddle, recalibrate, and prepare to fight with ten!",
        // additional variety
        "OFF! a shocking challenge and the referee has no option but red!",
        "a straight red — that was always going to end with a dismissal!",
        "OFF! the referee did not hesitate for a single moment — red card!",
        "a straight red card — and this game has been turned upside down!",
        "sent off! a moment of madness and now his side is down to ten!",
        "the referee goes to his pocket and it is red — no doubts whatsoever!",
        "a straight red card — he will certainly not be playing the next match either!",
        "OFF! no second chances — the referee points straight to the tunnel!",
        "dismissed for that! the referee brandishes red without a word of discussion!",
        "a straight red — an extraordinary and catastrophic moment for his side!",
    };
    ...
    private static readonly string[] SecondYellowReds =
    {
        ...
        // he knew the second was coming — the dreaded sequence
        "he knew it the moment he went in — a second yellow and that means red!",
        "he was warned after the first, and now a second yellow ends his afternoon!",
        "another reckless moment and the inevitable second yellow has come — he's off!",
        "he had the first yellow, he had the warning — and now a second sends him off!",
        "a second caution — he had been living dangerously and now he pays the price!",
        "two yellows and the red that follows — he should have known better!",
        "the referee showed him yellow once already; a second caution means the red is out!",
        // player reacting to the second yellow
        "shown the second yellow and the red — he puts his hands on his head in anguish!",
        "a second yellow, then red — he protests bitterly but the decision stands!",
        "dismissed for a second yellow and he looks utterly crestfallen as he departs!",
        "two yellows and he is off — shaking his head all the way to the tunnel!",
        "shown yellow for the second time and he slumps his shoulders — off he goes!",
        "a second booking and a red — he throws his arms wide but there is nothing to argue!",
        // team-mates and captain
        "team-mates swarm round the referee but the red is already in the air — he's off!",
        "the captain pleads his case but the second yellow has already become a red!",
        "players surround the official yet the second yellow is undeniable — he goes!",
        "the skipper does his best to limit the fallout but his man is walking!",
        "protests from all around but the referee is unmoved — two yellows, one red!",
        // trudging off
        "he makes that lonely walk to the dressing room — a second yellow has ended his tournament afternoon!",
        "trudges off alone, knowing he let his side down with a second needless caution!",
        "a slow, disconsolate walk to the tunnel — two yellows and the red card ends it!",
        "he heads for the dressing room early, a second yellow having cut short his match!",
        // team reorganising
        "ten men now — the manager must rethink everything on the touchline!",
        "down to ten after that second yellow and the side must reorganise without delay!",
        "a man fewer for the remainder — this side will have to be ruthlessly organised!",
        "ten men and a mountain to climb — the second yellow has changed everything!",
        // additional variety
        "a second yellow card and the red follows — you can\'t say he wasn\'t warned!",
        "the referee has been patient all game, but a second yellow is a second yellow!",
        "two yellows equals one red — the most straightforward dismissal of all!",
        "a second caution and the red is produced — the referee had to do it!",
        "his second yellow of the contest, and out comes the inevitable red card!",
        "cautioned twice and dismissed — the referee shows yellow then immediately red!",
        "a second yellow card — he leaves the pitch and his side are a man light!",
        "shown his second yellow and then the red — off without further discussion!",
        "two yellows in one match and he must go — a red card by any other name!",
        "the second yellow is raised, then the red — he turns and walks without a word!",
    };
